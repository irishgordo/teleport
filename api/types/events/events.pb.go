...
// DatabaseSessionStatement is emitted for database prepared statements.
type DatabaseSessionStatement struct {
	// Metadata is a common event metadata.
	Metadata `protobuf:"bytes,1,opt,name=Metadata,proto3,embedded=Metadata" json:""`
	// User is a common user event metadata.
	UserMetadata `protobuf:"bytes,2,opt,name=User,proto3,embedded=User" json:""`
	...
	// Database contains database related metadata.
	DatabaseMetadata `protobuf:"bytes,4,opt,name=Database,proto3,embedded=Database" json:""`
	// DatabaseQuery is the query text prepared statement will be created from.
	DatabaseQuery string `protobuf:"bytes,5,opt,name=DatabaseQuery,proto3" json:"db_query,omitempty"`
	// DatabaseStatement is the prepared statement name.
	//
	// Can be empty in case of Postgres unnamed statement.
	DatabaseStatement string `protobuf:"bytes,6,opt,name=DatabaseStatement,proto3" json:"db_statement,omitempty"`
	// DatabasePortal is the name of the destination portal that binds prepared
	// statement with the parameters.
	//
	// Only used by Postgres. Can be empty in case of unnamed portal.
	DatabasePortal       string   `protobuf:"bytes,7,opt,name=DatabasePortal,proto3" json:"db_portal,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *DatabaseSessionStatement) Reset()         { *m = DatabaseSessionStatement{} }
func (m *DatabaseSessionStatement) String() string { return proto.CompactTextString(m) }
func (*DatabaseSessionStatement) ProtoMessage()    {}
func (*DatabaseSessionStatement) Descriptor() ([]byte, []int) {
	return fileDescriptor_8f22242cb04491f9, []int{53}
}
func (m *DatabaseSessionStatement) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DatabaseSessionStatement) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DatabaseSessionStatement.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DatabaseSessionStatement) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DatabaseSessionStatement.Merge(m, src)
}
func (m *DatabaseSessionStatement) XXX_Size() int {
	return m.Size()
}
func (m *DatabaseSessionStatement) XXX_DiscardUnknown() {
	xxx_messageInfo_DatabaseSessionStatement.DiscardUnknown(m)
}

var xxx_messageInfo_DatabaseSessionStatement proto.InternalMessageInfo
...
type OneOf struct {
	...
	//	*OneOf_DatabaseSessionStatement
...
type OneOf_DatabaseSessionStatement struct {
	DatabaseSessionStatement *DatabaseSessionStatement `protobuf:"bytes,49,opt,name=DatabaseSessionStatement,proto3,oneof" json:"DatabaseSessionStatement,omitempty"`
}
...
func (*OneOf_DatabaseSessionStatement) isOneOf_Event()  {}
...
func (m *OneOf) GetDatabaseSessionStatement() *DatabaseSessionStatement {
	if x, ok := m.GetEvent().(*OneOf_DatabaseSessionStatement); ok {
		return x.DatabaseSessionStatement
	}
	return nil
}
...
func (*OneOf) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*OneOf_DatabaseSessionStatement)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*DatabaseSessionStatement)(nil), "events.DatabaseSessionStatement")
...
var fileDescriptor_8f22242cb04491f9 = []byte{
	...
	,
}
...
func (m *DatabaseSessionStatement) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DatabaseSessionStatement) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DatabaseSessionStatement) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.DatabasePortal) > 0 {
		i -= len(m.DatabasePortal)
		copy(dAtA[i:], m.DatabasePortal)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.DatabasePortal)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.DatabaseStatement) > 0 {
		i -= len(m.DatabaseStatement)
		copy(dAtA[i:], m.DatabaseStatement)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.DatabaseStatement)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.DatabaseQuery) > 0 {
...
func (m *OneOf_DatabaseSessionStatement) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OneOf_DatabaseSessionStatement) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DatabaseSessionStatement != nil {
		{
			size, err := m.DatabaseSessionStatement.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StreamStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n244, err244 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.LastUploadTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.LastUploadTime):])
	if err244 != nil {
		return 0, err244
	}
	i -= n244
	i = encodeVarintEvents(dAtA, i, uint64(n244))
	i--
	dAtA[i] = 0x1a
...
func (m *DatabaseSessionStatement) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.DatabaseStatement)
	if l > 0 {
		n += 1 + l + sovEvents(uint64(l))
	}
	l = len(m.DatabasePortal)
	if l > 0 {
		n += 1 + l + sovEvents(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *OneOf_DatabaseSessionStatement) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DatabaseSessionStatement != nil {
		l = m.DatabaseSessionStatement.Size()
		n += 2 + l + sovEvents(uint64(l))
	}
	return n
}
...
func (m *DatabaseSessionStatement) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DatabaseSessionStatement: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DatabaseSessionStatement: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DatabaseStatement", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DatabaseStatement = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DatabasePortal", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DatabasePortal = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
...
func (m *OneOf) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 49:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DatabaseSessionStatement", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &DatabaseSessionStatement{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Event = &OneOf_DatabaseSessionStatement{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
